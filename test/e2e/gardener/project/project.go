...
func DeleteProject(ctx SpecContext, s *ProjectContext) {
	GinkgoHelper()
...
func WaitForProjectToBeDeleted(ctx SpecContext, s *ProjectContext) {
	GinkgoHelper()
...
func WaitForProjectToBeReconciledAndReady(ctx SpecContext, s *ProjectContext) {
	GinkgoHelper()
